...
function AnimeSongPlaylistCard({ song, pageProps, idPlaylist, observer }: CardProps) {
    const composers = song.composers;
    const artists = song.artists;
    const arrangers = song.arrangers;

    const removeFromPlaylist = () => {
        pageProps().removeFromPlaylist(song.annSongId, idPlaylist, observer);
    }
            ...
            <div className="row">
                ...
                <div className="col-2 col-sm-1 d-flex align-items-center justify-content-end border-start">
                    ...
                    <ul className="dropdown-menu z-index-1035">
                        ...
                        <li>
                            <button className={`dropdown-item add-playlist song-id-${song.annSongId}`} onClick={removeFromPlaylist}>
                                <i className="bi bi-x-circle"></i>  Remove from PlayList
                            </button>
                        </li>
...
export default AnimeSongPlaylistCard